...
#define WR_PLATFORM_APPLE       0x00000004
#define WR_PLATFORM_ANDROID     0x00000008
#define WR_PLATFORM_CHROME_NACL 0x00000010
#define WR_PLATFORM_UNIX        0x00000020
#define WR_PLATFORM_QNXNTO      0x00000040
#define WR_PLATFORM_WINCE       0x00000080
#define WR_PLATFORM_CYGWIN      0x00000100
#define WR_PLATFORM_WASM        0x00000200

#define WR_PLATFORM_POSIX                                                                                \
    (WR_PLATFORM_LINUX | WR_PLATFORM_UNIX | WR_PLATFORM_APPLE | WR_PLATFORM_ANDROID | WR_PLATFORM_WASM | \
     WR_PLATFORM_QNXNTO | WR_PLATFORM_CHROME_NACL)
