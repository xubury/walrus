...
#ifndef WR_RHI_MAX_UNIFORM_BINDINGS
#define WR_RHI_MAX_UNIFORM_BINDINGS 14
#endif

#ifndef WR_RHI_MAX_FRAMEBUFFERS
#define WR_RHI_MAX_FRAMEBUFFERS (128)
#endif

#ifndef WR_RHI_MAX_FRAMEBUFFER_ATTACHMENTS
...
#define WR_RHI_CLEAR_DISCARD_MASK \
    (0 | WR_RHI_CLEAR_DISCARD_COLOR_MASK | WR_RHI_CLEAR_DISCARD_DEPTH | WR_RHI_CLEAR_DISCARD_STENCIL)
/**
...
#define WR_RHI_RESOLUTION_NONE 0

#define WR_RHI_RESOLUTION_MSAA_X2    UINT32_C(0x00000010)  //!< Enable 2x MSAA.
#define WR_RHI_RESOLUTION_MSAA_X4    UINT32_C(0x00000020)  //!< Enable 4x MSAA.
#define WR_RHI_RESOLUTION_MSAA_X8    UINT32_C(0x00000030)  //!< Enable 8x MSAA.
#define WR_RHI_RESOLUTION_MSAA_X16   UINT32_C(0x00000040)  //!< Enable 16x MSAA.
#define WR_RHI_RESOLUTION_MSAA_SHIFT 4

#define WR_RHI_RESOLUTION_MSAA_MASK UINT32_C(0x00000070)
