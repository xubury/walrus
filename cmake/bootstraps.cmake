...
set(walrus_library_dir ${CMAKE_SOURCE_DIR}/libs)
set(WASI_SDK_PREFIX ${walrus_library_dir}/wasi-sdk-${WASI_VERSION_FULL})
...
if(NOT EXISTS ${WASI_SDK_PREFIX})
  ...
  file(ARCHIVE_EXTRACT INPUT ${WASI_PACKAGE} DESTINATION ${walrus_library_dir})
